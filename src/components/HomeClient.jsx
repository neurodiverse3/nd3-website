  ...
  return (
    <div className="bg-bg-primary text-fg-primary font-sans antialiased selection:bg-accent selection:text-bg-primary">
      ...
      <section className="relative min-h-0 md:min-h-[100svh] h-auto flex flex-col px-6 md:px-24 overflow-hidden border-b border-border-rule py-12 md:py-16 lg:py-20">
        <div className="max-w-7xl w-full mx-auto flex-1 flex flex-col justify-center relative z-10 items-start text-left pt-8 md:pt-[84px] pb-2">
          <div
            className="inline-block text-xs md:text-sm font-mono tracking-[0.16em] md:tracking-[0.25em] text-[var(--accent-label,var(--accent))] bg-[var(--accent-soft)] px-2.5 py-1 uppercase border border-border-rule mb-4 md:mb-4 max-w-full leading-normal"
          >
            NEURODIVERGENT LIFE, TOOLS AND STORIES
          </div>

          <h1 className="text-[2.65rem] sm:text-5xl md:text-[6rem] lg:text-[7rem] xl:text-[7.8rem] font-black leading-[1.05] tracking-[-0.02em] uppercase mb-3 md:mb-3">
