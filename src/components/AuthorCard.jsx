...
export default function AuthorCard({ author = {}, socials = {} }) {
  ...
  return (
    <div className="w-full bg-[#09090b]/60 border-2 border-border-rule p-6 md:p-8 shadow-[4px_4px_0px_var(--rule)] hover:border-accent-pink hover:shadow-[6px_6px_0px_rgba(255,46,136,0.15)] transition-all duration-300 relative text-left">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
        ...
        <div className="flex-grow space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-2">
            <Link
              href="/about"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-border-rule bg-[#050505] text-[10px] font-black uppercase tracking-widest text-fg-primary hover:text-accent-pink hover:border-accent-pink transition-all duration-200 focus-ring"
            >
