...
export const metadata = {
  ...
  verification: {
    google: 'cQztUq5GuKq3dOpFZaiRazQdhHFV_ok_9wGIRjQaQDY',
  },
  openGraph: {
    title: 'neurodivers³ - Neurodivergent life, tools and stories',
    description: 'An honest blog and slow-burn memoir about late-diagnosed ADHD, burnout, and building tiny systems for an unmasked life.',
...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en-GB" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} ${outfit.variable} font-sans bg-bg text-fg selection:bg-accent selection:text-bg overflow-x-clip`} suppressHydrationWarning>
        <ThemeProvider>
          <GlobalVisualSnow />
          <BrainStateProvider>
            <PWARegister />
